...
product_options = dash_functions.product_select_data()[0]
...
def tab_1_content():
    tab_1 = dcc.Tab(
        ...
        children=[
            ...
            # первый ряд графиков будут графики
                         ...
                         dbc.Row([
                             dbc.Col(width=7,
                                     children=[
                                         html.Div([
                                             ...
                                             html.Div(style={'marginTop': '10px'},
                                                      children=[
                                                          dcc.Graph(id="next_payments_by_products"),
                                                      ]
                                                      ),
                             ...
                             dbc.Col(width=5,
                                     children=[
                                         ...
                                         html.Div(style={'marginTop': '10px'},
                                                  children=[
                                                      dcc.Graph(id="pie_chart_products"),
                                                  ]
                                                  ),
                                     ]
